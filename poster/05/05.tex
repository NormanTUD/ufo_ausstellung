...
\begin{itemize}
    ...
    \qr{https://en.wikipedia.org/wiki/Prime-counting_function}

    \item Darunter sind ein Re-Entry, ein Satellit, der in der Atmosphäre verglüht, und Starlink, das Satellitensystem von Musk. \qr{https://en.wikipedia.org/wiki/Atmospheric_entry} \qr{https://en.wikipedia.org/wiki/Starlink}
