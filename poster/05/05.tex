...
\begin{itemize}
    ...
    \qr[\wikipedia{} Prime-Counting-Function $\pi$]{https://en.wikipedia.org/wiki/Prime-counting_function}

    \item Darunter sind ein Re-Entry, ein Satellit, der in der Atmosphäre verglüht, und Starlink, das Satellitensystem von Musk. \qr[\wikipedia{} Re-Entrys]{https://en.wikipedia.org/wiki/Atmospheric_entry} \qr[\wikipedia{} Starlink]{https://en.wikipedia.org/wiki/Starlink}
